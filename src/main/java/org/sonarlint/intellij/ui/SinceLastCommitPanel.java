...
public class SinceLastCommitPanel extends SimpleToolWindowPanel implements Disposable {
  ...
  public SinceLastCommitPanel(Project project) {
    super(false, true);
  ...
  public void update(Map<VirtualFile, Collection<LiveIssue>> issues) {
    if (project.isDisposed()) {
      return;
    }
    treeBuilder.updateModel(issues, "No issues found");
