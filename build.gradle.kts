...
tasks.runPluginVerifier {
    ...
    ideVersions.set(listOf("PC-2021.3"))
    failureLevel.set(
...
dependencies {
    ...
    "sqplugins"("org.sonarsource.python:sonar-python-plugin:4.0.0.11155")
    ...
    "sqplugins"("org.sonarsource.sonarlint.omnisharp:sonarlint-omnisharp-plugin:1.7.0.63188")
