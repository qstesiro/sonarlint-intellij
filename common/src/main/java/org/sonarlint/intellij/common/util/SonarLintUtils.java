...
public class SonarLintUtils {
    ...
    private static final String[] SONARCLOUD_ALIAS = {
        "https://sonarqube.com",
    ...
    /**
     * FileEditorManager#getSelectedFiles does not work as expected.
     * In split editors, the order of the files does not change depending
    ...
    public static boolean isGeneratedSource(SourceFolder sourceFolder) {
        // copied from JavaProjectRootsUtil.
        // Don't use that class because it's not available in other flavors of Intellij
        ...
        return (properties != null && properties.isForGeneratedSources()) ||
            (resourceProperties != null && resourceProperties.isForGeneratedSources());
    }
